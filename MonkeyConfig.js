 ...
 * Updated: April 2025 - Scrollable labels on small dimensions, customizable checkbox/number sizes, corner positioning
 */
    function MonkeyConfig(data) {
        ...
        function render() {
            ...
            html += `</div><div class="__MonkeyConfig_corners"><div class="__MonkeyConfig_left_top">`;
            ...
            html += `</div></div><div class="__MonkeyConfig_corners"><div class="__MonkeyConfig_left_bottom">`;
...
.__MonkeyConfig_corners { display: flex !important; justify-content: space-between !important; margin-bottom: 1em !important; }
...
@media (max-width: 600px) {
    .__MonkeyConfig_columns, .__MonkeyConfig_corners { flex-direction: column !important; }
