 ...
 * Fixed: Made dialog more compact, buttons visible without scrolling - March 2025
 */
function MonkeyConfig(data) {
    ...
    function init() {
        ...
        data.fontSize = data.fontSize || '12pt'; // Kurangi font-size agar lebih kompak
    ...
    function forcePositionAndSize() {
        ...
        var maxHeight = Math.min(viewportHeight * 0.5, 300); // Batasi tinggi maksimum agar tombol terlihat
    ...
    stylesheets: {
        main: `
            ...
            .__MonkeyConfig_container {
                ...
                padding: 0.3em !important; /* Kurangi padding */
                font-size: 12pt !important;
                color: #333333 !important;
                background: rgba(255, 255, 255, 0.95) !important;
                border-radius: 0.5em !important;
            ...
            .__MonkeyConfig_container h1 {
                ...
                font-size: 110% !important; /* Kurangi ukuran judul */
                margin: 0 0 0.2em 0 !important; /* Kurangi margin */
                padding: 0 0 0.1em 0 !important; /* Kurangi padding */
            ...
            .__MonkeyConfig_content {
                ...
                max-height: 200px !important; /* Kurangi max-height */
            }
            .__MonkeyConfig_top, .__MonkeyConfig_bottom {
                margin-bottom: 0.2em !important; /* Kurangi margin */
            }
            ...
            .__MonkeyConfig_container td {
                ...
                padding: 0.1em !important; /* Kurangi padding */
            ...
            .__MonkeyConfig_container td.__MonkeyConfig_inline label {
                margin-right: 0.3em !important; /* Kurangi margin */
            ...
            .__MonkeyConfig_container td.__MonkeyConfig_inline input[type="checkbox"] {
                ...
                margin: 0 0.2em 0 0 !important; /* Kurangi margin */
                display: inline-block !important;
                width: 14px !important; /* Kurangi ukuran */
            ...
            .__MonkeyConfig_container td.__MonkeyConfig_inline input[type="text"] {
                flex-grow: 0 !important;
                width: 80px !important; /* Kurangi lebar */
                min-width: 40px !important;
            }
            .__MonkeyConfig_buttons_container {
                margin-top: 0.2em !important; /* Kurangi margin */
                border-top: solid 1px #999 !important;
                padding-top: 0.2em !important; /* Kurangi padding */
                text-align: center !important;
                flex-shrink: 0 !important;
            }
            ...
            .__MonkeyConfig_container button {
                ...
                padding: 2px 6px 2px 20px !important; /* Kurangi padding */
                white-space: nowrap !important;
                font-size: 12pt !important;
                color: #333333 !important;
            }
            .__MonkeyConfig_container button img {
                vertical-align: middle !important;
                width: 14px !important; /* Kurangi ukuran ikon */
                height: 14px !important;
            }
            .__MonkeyConfig_container label {
                line-height: 100% !important; /* Kurangi line-height */
                vertical-align: middle !important;
                display: inline-block !important;
            }
