 ...
 * Additions: Auto-scrolling labels for small dimensions, customizable checkbox/number sizes, new column layouts (left&top, right&top, left&bottom, right&bottom)
 * Modified: Checkbox and number inputs with manual width/height, enhanced styling for Shadow DOM and iframe
 * Fixed: Consistent label scrolling and layout rendering across Shadow DOM and iframe
 */
...
MonkeyConfig.formatters = {
    tr: (name, opt) => `<tr>${['checkbox', 'number', 'text'].includes交叉
...
.__MonkeyConfig_top, .__MonkeyConfig_bottom, .__MonkeyConfig_left_top, .__MonkeyConfig_right_top, .__MonkeyConfig_left_bottom, .__MonkeyConfig_right_bottom { margin-bottom: 1em !important; }
...
.__MonkeyConfig_container td.__MonkeyConfig_inline label { margin-right: 0.5em !important; flex-shrink: 0 !important; display: block !important; overflow-x: auto !important; white-space: nowrap !important; scrollbar-width: thin !important; }
...
.__MonkeyConfig_container label { line-height: 120% !important; vertical-align: middle !important; display: inline-block !important; }
...
@media (max-width: 600px) { 
    ...
    .__MonkeyConfig_left_column, .__MonkeyConfig_right_column { width: 100% !important; }
    .__MonkeyConfig_container td.__MonkeyConfig_inline label { overflow-x: auto !important; white-space: nowrap !important; scrollbar-width: thin !important; }
}`
    }
};
...
const config = new MonkeyConfig({
    ...
    parameters: {
        ...
        threshold: {
            type: "number",
            label: "Set Threshold Value for Processing",
            default: 50,
            min: 0,
            max: 100,
            width: "60px",
