 ...
 * Fixed: Dialog positioning to ensure visibility in viewport - March 2025
 * Fixed: Scope of defaultOverlaySize and adjustOverlaySize for close function - March 2025
 */
function MonkeyConfig(data) {
    ...
    function open() {
        ...
        function openDone() {
            ...
            console.log('MonkeyConfig: Layer position:', layer.getBoundingClientRect());
