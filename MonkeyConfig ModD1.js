 ...
 * Version 1.9.1 - Added support for multi-line textarea and fixed labelAlign
 */
...
MonkeyConfig.HTML = {
    ...
    'textarea': function (name, options) {
        var style = options.labelAlign ? 'text-align: ' + options.labelAlign + ';' : '';
        return '<textarea id="__MonkeyConfig_field_' + name + '" class="__MonkeyConfig_field_text" name="' + name + '" rows="' + (options.rows || 4) + '" cols="' + (options.cols || 20) + '" style="' + style + '"></textarea>';
    },
    ...
    stylesheets: {
        main: `
            ...
            .__MonkeyConfig_container textarea {
                ...
                width: 100%;
                text-align: center; /* Tambahkan ini untuk mengatur teks di tengah */
            }
