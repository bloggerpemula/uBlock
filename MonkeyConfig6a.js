 ...
 * v2.2 Updates - March 2025:
 * - Fixed overlay visibility issue
 * - Added debug logging for initialization, opening, and rendering
 * - Improved Shadow DOM structure and styling
 */
...
function MonkeyConfig(data) {
    ...
    function log(message, data) {
        console.log(`[MonkeyConfig v2.2] ${message}`, data || '');
    }
    ...
    function open() {
        ...
        shadowRoot.innerHTML = `
            <style>
                :host {
                    ...
                    isolation: isolate; /* Mengisolasi elemen dari CSS eksternal */
                }
        ...
        openLayer.style.cssText = 'position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 9998;';
