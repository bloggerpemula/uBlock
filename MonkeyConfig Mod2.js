...
// @description    EEnhanced Configuration Dialog Builder with column layout , custom styling , and Additional input types
// @noframes
// @version        1.8
// ==/UserScript==
/*
 ...
 */
    ...
    function open() {
        function openDone() {if (window.self !== window.top) return;
