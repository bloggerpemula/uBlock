 ...
 * Fixed: Improved dialog visibility and compactness - March 2025
 */
function MonkeyConfig(data) {
    ...
    function init() {
        ...
        data.fontSize = data.fontSize || '14pt'; // Besarkan font-size
        data.fontColor = data.fontColor || '#333333'; // Warna lebih gelap untuk kontras
    ...
    function forcePositionAndSize() {
        ...
        console.log('MonkeyConfig: Container background:', container.style.background);
        console.log('MonkeyConfig: Font size:', container.style.fontSize);
    }
            ...
            shadowRoot.innerHTML = `
                <style>
                    ...
                    .__MonkeyConfig_container {
                        ...
                        z-index: 10000 !important;
                        background: rgba(255, 255, 255, 0.95) !important; /* Lebih buram */
                        width: ${data.width} !important;
                        min-width: ${data.width} !important;
                        max-width: ${data.width} !important;
    ...
    stylesheets: {
        main: `
            ...
            .__MonkeyConfig_container {
                ...
                padding: 0.5em !important; /* Kurangi padding */
            ...
            .__MonkeyConfig_container h1 {
                ...
                margin: 0 0 0.3em 0 !important; /* Kurangi margin */
                padding: 0 0 0.2em 0 !important; /* Kurangi padding */
                text-align: center !important;
                font-weight: bold !important; /* Bold untuk judul */
            }
            ...
            .__MonkeyConfig_top, .__MonkeyConfig_bottom {
                margin-bottom: 0.5em !important; /* Kurangi margin */
            }
            ...
            .__MonkeyConfig_container td {
                ...
                padding: 0.2em !important; /* Kurangi padding */
            ...
            .__MonkeyConfig_container td.__MonkeyConfig_inline label {
                ...
                display: block !important;
                font-weight: 500 !important; /* Sedikit bold untuk label */
            }
            ...
            .__MonkeyConfig_buttons_container {
                margin-top: 0.5em !important; /* Kurangi margin */
                border-top: solid 1px #999 !important;
                padding-top: 0.3em !important; /* Kurangi padding */
                text-align: center !important;
                flex-shrink: 0 !important;
            }
