 ...
 * Fixed: Recalculate position after render for true centering - March 2025
 * Fixed: Overlay to cover full viewport - March 2025
 */
function MonkeyConfig(data) {
    ...
    function forcePositionAndSize() {
        ...
        var dialogHeight = layer.getBoundingClientRect().height; // Tinggi aktual setelah render
        ...
        console.log('MonkeyConfig: Forced position - top:', layer.style.top, 'left:', layer.style.left, 'width:', layer.style.width, 'height:', dialogHeight + 'px');
    }
    ...
    function open() {
        ...
        function openDone() {
            ...
            console.log('MonkeyConfig: Overlay position before:', overlay.getBoundingClientRect());
