...
function MonkeyConfig(data) {
    ...
    function init() {
        ...
        data.width = data.width || '500px'; // Default width
    ...
    function update() {
        ...
        for (var paramName in params) {
            ...
            if (label) {
                ...
                label.style.textAlign = params[paramName].labelAlign || 'left'; // Tambahkan text-align untuk label
            }
        }
    }
    ...
    function open() {
        ...
        container.style.width = data.width; // Set width
        container.style.height = data.height; // Set height
...
MonkeyConfig.res = {
    icons: {
        'arrow_undo': '',
        'cancel': 'iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAABGdBTUEAAK/INwWK6QAAABl0RVh0\U29mdHdhcmUAQWRvYmUgSW1hZ2VSZWFkeXHJZTwAAAHdSURBVDjLpZNraxpBFIb3a0ggISmmNISW\XmOboKihxpgUNGWNSpvaS6RpKL3Ry//Mh1wgf6PElaCyzq67O09nVjdVlJbSDy8Lw77PmfecMwZg\I/GDw3DCo8HCkZl/RlgGA0e3Yfv7+DbAfLrW+SXOvLTG+SHV/gPbuMZRnsyIDL/OASziMxkkKkU\QTJJsLaGn8/iHz6nd+8mQv87Ahg2H9Th/BxZqxEkEgSrq/iVCvLsDK9awtvfxb2zjD2ARID+lVVl\babTgWYTv1rFL5fBUtHbbeTJCb3EQ3ovCnRC6xAgzJtOE+ztheYIEkqbFaS3vY2zuIj77AmtYYDu\sPy8/zuvunJkDKXM7tYWTiyGWFjAqeQnAD6+7ueNx/FLpRGAru7mcoj5ebqzszil7DggeF/DX1nB\B980rzLrrzbTaiEvLhBqMvb0N87TdS2GAZ4GqBF5j1PI09N+1UYDd3MTZ2MjNEsFCY6O6C5fRxTT\owBXbZier1cv45kFguPj0KzzdufmELq5yizWk4idDO2lazQN4+fIIqnlsPR8ey93cON3rvLaMzPY\U1PYS7GwcivIPLbKajks+9YN3GoeZzeHY2bDvKKYQRRSo+aJj0l119IdjnQ5ULOv5t9f4z/oF5xX\4g72e3b8AAAAASUVORK5CYII=',
    ...
    stylesheets: {
        main: `
            ...
            div.__MonkeyConfig_container {display:flex !important;flex-direction:column !important;font-family:sans-serif !important;padding:1em !important;font-size:__FONT_SIZE__;color:__FONT_COLOR__;background:#eee linear-gradient(180deg,#f8f8f8 0,#ddd 100%) !important;border-radius:0.5em !important;box-shadow:2px 2px 16px #000 !important;max-width:90vw !important;width:__WIDTH__ !important;height:__HEIGHT__ !important;}
            ...
            div.__MonkeyConfig_container td.__MonkeyConfig_inline label {margin-right:0.5em !important;flex-shrink:0 !important;display:block !important;text-align:__LABEL_ALIGN__ !important;}
            ...
            div.__MonkeyConfig_layer div.__MonkeyConfig_container button {font-family:sans-serif !important;line-height:100% !important;margin:0 !important;vertical-align:baseline !important;}
