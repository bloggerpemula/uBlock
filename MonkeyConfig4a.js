 ...
 * Fixed: Further compacted dialog, ensured buttons are visible without scrolling - March 2025
 */
function MonkeyConfig(data) {
    ...
    function init() {
        ...
        data.fontSize = data.fontSize || '12pt'; // Pastikan font-size 12pt
        data.fontColor = data.fontColor || '#333333';
    ...
    function forcePositionAndSize() {
        ...
        var content = shadowRoot.querySelector('.__MonkeyConfig_content');
        var buttonsContainer = shadowRoot.querySelector('.__MonkeyConfig_buttons_container');
        var header = shadowRoot.querySelector('.__MonkeyConfig_container h1');
        ...
        var maxHeight = Math.min(viewportHeight * 0.4, 200); // Batasi tinggi maksimum lebih ketat

        // Paksa lebar dan tinggi container
        container.style.width = `${dialogWidth}px`;
        container.style.minWidth = `${dialogWidth}px`;
        container.style.maxWidth = `${dialogWidth}px`;
        container.style.height = 'auto';
        container.style.maxHeight = `${maxHeight}px`;
        container.style.overflowY = 'auto';
        // Paksa background dan font-size secara inline
        container.style.background = 'rgba(255, 255, 255, 0.95)';
        container.style.fontSize = data.fontSize; // Pastikan 12pt
        container.style.color = data.fontColor;

        // Paksa posisi layer
        layer.style.position = 'fixed';
        layer.style.width = `${dialogWidth}px`;
        layer.style.minWidth = `${dialogWidth}px`;
        ...
        console.log('MonkeyConfig: Container effective width:', container.getBoundingClientRect().width);
        console.log('MonkeyConfig: Container height:', dialogHeight);
        console.log('MonkeyConfig: Header height:', header ? header.getBoundingClientRect().height : 'null');
        console.log('MonkeyConfig: Content height:', content ? content.getBoundingClientRect().height : 'null');
        console.log('MonkeyConfig: Buttons container height:', buttonsContainer ? buttonsContainer.getBoundingClientRect().height : 'null');
        console.log('MonkeyConfig: Container inline background:', container.style.background);
        console.log('MonkeyConfig: Container computed background:', computedStyle.background);
        console.log('MonkeyConfig: Container inline font size:', container.style.fontSize);
        console.log('MonkeyConfig: Container computed font size:', computedStyle.fontSize);
    }
    ...
    function open() {
        ...
        try {
            ...
            // Buat overlay di luar Shadow DOM
            ...
            shadowRoot.innerHTML = `
                <style>
                    ...
                    .__MonkeyConfig_layer {
                        ...
                        min-width: ${data.width} !important;
            ...
            setTimeout(openDone, 200); // Beri waktu untuk rendering
        } catch (e) {
    ...
    stylesheets: {
        main: `
            ...
            .__MonkeyConfig_container {
                ...
                padding: 0.2em !important; /* Kurangi lagi padding */
                font-size: 12pt !important;
                color: #333333 !important;
                background: rgba(255, 255, 255, 0.95) !important;
                border-radius: 0.5em !important;
            ...
            .__MonkeyConfig_container h1 {
                ...
                font-size: 100% !important; /* Kurangi lagi ukuran judul */
                margin: 0 0 0.1em 0 !important; /* Kurangi margin */
                padding: 0 0 0.05em 0 !important; /* Kurangi padding */
            ...
            .__MonkeyConfig_content {
                ...
                max-height: 150px !important; /* Kurangi lagi max-height */
            }
            .__MonkeyConfig_top, .__MonkeyConfig_bottom {
                margin-bottom: 0.1em !important; /* Kurangi margin */
            }
            ...
            .__MonkeyConfig_container td {
                ...
                padding: 0.05em !important; /* Kurangi lagi padding */
            ...
            .__MonkeyConfig_container td.__MonkeyConfig_inline label {
                margin-right: 0.2em !important; /* Kurangi lagi margin */
            ...
            .__MonkeyConfig_container td.__MonkeyConfig_inline input[type="checkbox"] {
                ...
                margin: 0 0.1em 0 0 !important; /* Kurangi lagi margin */
                display: inline-block !important;
                width: 12px !important; /* Kurangi lagi ukuran */
            ...
            .__MonkeyConfig_container td.__MonkeyConfig_inline input[type="text"] {
                flex-grow: 0 !important;
                width: 60px !important; /* Kurangi lagi lebar */
                min-width: 30px !important;
            }
            .__MonkeyConfig_buttons_container {
                margin-top: 0.1em !important; /* Kurangi lagi margin */
                border-top: solid 1px #999 !important;
                padding-top: 0.1em !important; /* Kurangi lagi padding */
                text-align: center !important;
                flex-shrink: 0 !important;
            }
            ...
            .__MonkeyConfig_container button {
                ...
                padding: 1px 4px 1px 16px !important; /* Kurangi lagi padding */
                white-space: nowrap !important;
                font-size: 10pt !important; /* Kurangi font-size tombol */
                color: #333333 !important;
            }
            .__MonkeyConfig_container button img {
                vertical-align: middle !important;
                width: 12px !important; /* Kurangi lagi ukuran ikon */
                height: 12px !important;
            }
