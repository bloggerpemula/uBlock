 ...
 * v2.3 Updates - March 2025:
 * - Fixed centering and background issues on specific sites (e.g., videolyrics.in)
 * - Increased z-index for better overlay visibility
 * - Added more detailed logging for positioning and styling
 */
...
function MonkeyConfig(data) {
    ...
    function log(message, data) {
        console.log(`[MonkeyConfig v2.3] ${message}`, data || '');
    }
    ...
    function open() {
        ...
        shadowRoot.innerHTML = `
            <style>
                :host {
                    ...
                    isolation: isolate;
                    z-index: 2147483647; /* Nilai z-index maksimum */
                }
                ...
                .__MonkeyConfig_overlay {
                    ...
                    z-index: 2147483646; /* Satu tingkat di bawah container */
                }
        ...
        openLayer.style.cssText = 'position: fixed; top: 0; left: 0; width: 100%; height: 100%; z-index: 2147483647;';
