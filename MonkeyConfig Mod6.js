 ...
 * Fixed: Ensured consistent styling across all sites - March 2025
 */
...
function MonkeyConfig(data) {
    ...
    function update() {
        ...
        for (var paramName in params) {
            ...
            // Terapkan font-size dan font-color pada elemen input
            elem.style.fontSize = params[paramName].fontSize || data.fontSize;
            elem.style.color = params[paramName].fontColor || data.fontColor;
            // Terapkan font-size dan font-color pada label
            var label = container.querySelector('label[for="__MonkeyConfig_field_' + paramName + '"]');
            if (label) {
                label.style.fontSize = params[paramName].fontSize || data.fontSize;
                label.style.color = params[paramName].fontColor || data.fontColor;
                label.style.textAlign = params[paramName].labelAlign || 'left'; // Pastikan labelAlign diterapkan
            }
        }
    }
    ...
    function open() {
        ...
        openLayer.style.cssText = 'position:fixed !important;top:50% !important;left:50% !important;transform:translate(-50%,-50%) !important;max-height:80vh !important;overflow-y:auto !important;z-index:10000 !important;';
...
MonkeyConfig.HTML = {
    ...
    '_label': function (name, options) {
        ...
        var styles = [];
        if (options.labelAlign) styles.push('text-align:' + options.labelAlign + ' !important');
        if (options.fontSize) styles.push('font-size:' + options.fontSize + ' !important');
        if (options.fontColor) styles.push('color:' + options.fontColor + ' !important');
...
g/2e3b8AAAAASUVORK5CYII=',
    ...
    stylesheets: {
        main: `
            /* Pastikan overlay dan layer konsisten */
            .__MonkeyConfig_overlay {background-color:#000 !important;opacity:0.6 !important;position:fixed !important;left:0 !important;top:0 !important;width:100% !important;height:100% !important;z-index:9999 !important;}
            .__MonkeyConfig_layer {display:block !important;position:fixed !important;top:50% !important;left:50% !important;transform:translate(-50%,-50%) !important;max-height:80vh !important;overflow-y:auto !important;z-index:10000 !important;}
            
            /* Container utama */
            .__MonkeyConfig_container {display:flex !important;flex-direction:column !important;font-family:sans-serif !important;padding:1em !important;background:#eee linear-gradient(180deg,#f8f8f8 0,#ddd 100%) !important;border-radius:0.5em !important;box-shadow:2px 2px 16px #000 !important;max-width:90vw !important;min-width:300px !important;box-sizing:border-box !important;}
            
            /* Header */
            .__MonkeyConfig_container h1 {border-bottom:solid 1px #999 !important;font-family:sans-serif !important;font-size:120% !important;margin:0 0 0.5em 0 !important;padding:0 0 0.3em 0 !important;text-align:center !important;}
            ...
            .__MonkeyConfig_container table td {border:none !important;line-height:100% !important;padding:0.3em !important;text-align:left !important;vertical-align:middle !important;white-space:normal !important;}
            ...
            .__MonkeyConfig_container td.__MonkeyConfig_inline label {margin-right:0.5em !important;flex-shrink:0 !important;display:block !important;}
            .__MonkeyConfig_container td.__MonkeyConfig_inline input[type="checkbox"] {flex-grow:0 !important;}
            .__MonkeyConfig_container td.__MonkeyConfig_inline input[type="number"],
            .__MonkeyConfig_container td.__MonkeyConfig_inline input[type="text"] {flex-grow:0 !important;width:100px !important;min-width:50px !important;}
            ...
            .__MonkeyConfig_container td.__MonkeyConfig_buttons button {appearance:button !important;-moz-appearance:button !important;background:#ccc linear-gradient(180deg,#ddd 0,#ccc 45%,#bbb 50%,#aaa 100%) !important;border-style:solid !important;border-width:1px !important;border-radius:0.5em !important;box-shadow:0 0 1px #000 !important;padding:3px 8px 3px 24px !important;white-space:nowrap !important;}
            .__MonkeyConfig_container td.__MonkeyConfig_buttons button img {vertical-align:middle !important;}
            .__MonkeyConfig_container td.__MonkeyConfig_buttons button:hover {background:#d2d2d2 linear-gradient(180deg,#e2e2e2 0,#d2d2d2 45%,#c2c2c2 50%,#b2b2b2 100%) !important;}
            
            /* Elemen dalam container */
            .__MonkeyConfig_container label {line-height:120% !important;vertical-align:middle !important;}
            .__MonkeyConfig_container textarea {vertical-align:text-top !important;width:100% !important;}
            .__MonkeyConfig_container input[type="text"] {appearance:textfield !important;-moz-appearance:textfield !important;background:#fff !important;}
        `
    }
};