...
function MonkeyConfig(data) {
    ...
    function open() {
        ...
        // Sesuaikan height hanya jika bukan 'auto'
        const heightStyle = this.shadowHeight === 'auto' ? '' : `height: ${this.shadowHeight} !important;`;
        shadowRoot.innerHTML = `
            <style>
                ...
                .__MonkeyConfig_container { position: fixed !important; top: 50% !important; left: 50% !important; transform: translate(-50%, -50%) !important; z-index: 2147483647 !important; width: ${this.shadowWidth} !important; ${heightStyle} max-width: 90vw !important; max-height: 80vh !important; overflow-y: auto !important; }
            </style>
