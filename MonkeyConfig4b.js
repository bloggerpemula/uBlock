...
function MonkeyConfig(data) {
    ...
    function log(message, data) {
        console.log(`[MonkeyConfig v2.6] ${message}`, data || '');
    }
            ...
            switch (params[paramName].type) {
                ...
                case 'select':
                    if (elem.tagName.toLowerCase() === 'input' && elem.type === 'checkbox') {
                        var checkboxesSHIP = root.querySelectorAll('input[name="' + paramName + '"]');
    ...
    function open() {
        ...
        function adjustIframeSize(container) {
            ...
            iframeFallback.style.width = (rect.width + 20) + 'px'; // Tambah padding
            iframeFallback.style.height = (rect.height + 20) + 'px';
